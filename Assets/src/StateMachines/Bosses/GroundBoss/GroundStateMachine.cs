...
public class GroundStateMachine : StateMachine
{
    ...
    [field:SerializeField] public ParticleSystem ParticleHealing {get;private set;}
   ...
   //this is for the special attacl
    ...
    private bool isDeath;
     ...
     private void Start(){
        ...
        if(BossManager.IsGrounded()){
            SwitchState(new GroundIdleState(this));
        }else{
            SwitchState(new GroundFallState(this));
        }
    ...
    public override void CustomUpdate(float deltatime)
    {
       ...
       // Debug.Log("THis is the health" + currentHealth);
        ...
        !(BossManager.Health.maxhealth == BossManager.Health.GetHealth())){
            ...
            isHealing = true;
            SwitchState(new GroundHealingState(this));
            return;
        }
    ...
    private void HandleDeath(){
        isDeath = true;
        SwitchState(new GroundDeathState(this));
    }
     ...
     private void HandleImpact(Vector2 directionknockback){
           ...
           // Debug.Log("should change to impact state");
            ...
            //flash red
            //Set the healing every time that there is an impact
            StartCoroutine(FlashRed());
            if(!isHealing){
                setTimeForHeal = HowLongBeforeHeal;
            }
            ...
            if(!canAttack){
                SwitchState(new GroundImpacState(this,directionknockback));
            }
